...
type PostStatusRequest struct {
	...
	CurrentBundleSerial string `protobuf:"bytes,1,opt,name=current_bundle_serial,json=currentBundleSerial,proto3" json:"current_bundle_serial,omitempty"`
}
...
func (x *PostStatusRequest) GetCurrentBundleSerial() string {
	if x != nil {
...
type PostStatusResponse struct {
	...
	TaintedKeys [][]byte `protobuf:"bytes,1,rep,name=tainted_keys,json=taintedKeys,proto3" json:"tainted_keys,omitempty"`
}
...
func (x *PostStatusResponse) GetTaintedKeys() [][]byte {
	if x != nil {
...
var file_spire_api_server_agent_v1_agent_proto_rawDesc = []byte{
	...
	0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x63, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x37,
	0x0a, 0x12, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x74, 0x61, 0x69, 0x6e, 0x74, 0x65, 0x64, 0x5f,
	0x6b, 0x65, 0x79, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0b, 0x74, 0x61, 0x69, 0x6e,
	0x74, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x73, 0x32, 0x80, 0x07, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e,
