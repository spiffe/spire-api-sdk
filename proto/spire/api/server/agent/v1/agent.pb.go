...
type PostStatusRequest struct {
	...
	CurrentBundleSerial int64 `protobuf:"varint,1,opt,name=current_bundle_serial,json=currentBundleSerial,proto3" json:"current_bundle_serial,omitempty"`
}
...
func (x *PostStatusRequest) GetCurrentBundleSerial() int64 {
	if x != nil {
...
var file_spire_api_server_agent_v1_agent_proto_rawDesc = []byte{
	...
	0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x13, 0x63, 0x75, 0x72, 0x72, 0x65,
	...
	0x72, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x61, 0x67, 0x65, 0x6e, 0x74,
