...
func (x *FederationRelationship) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
type FederationRelationship_Spiffe struct {
	...
	Spiffe *SPIFFEAuthentication `protobuf:"bytes,3,opt,name=spiffe,proto3,oneof"`
}

type FederationRelationship_WebPki struct {
	// Use Web PKI authentication.
	WebPki *WebPKIAuthentication `protobuf:"bytes,4,opt,name=web_pki,json=webPki,proto3,oneof"`
}
...
type FederationRelationshipMask struct {
	...
	// URL field mask.
	Url bool `protobuf:"varint,1,opt,name=url,proto3" json:"url,omitempty"`
	// Authentication field mask.
	Authentication bool `protobuf:"varint,2,opt,name=authentication,proto3" json:"authentication,omitempty"`
}
...
func (x *FederationRelationshipMask) GetUrl() bool {
	if x != nil {
		return x.Url
	}
	return false
...
var file_spire_api_types_federationrelationship_proto_rawDesc = []byte{
	...
	0xe2, 0x01, 0x0a, 0x16, 0x46, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	,
	...
	,
