...
type FederationRelationship struct {
	...
	//	*FederationRelationship_SpiffeId
	//	*FederationRelationship_UseWebPki
...
func (x *FederationRelationship) GetSpiffeId() string {
	if x, ok := x.GetAuthentication().(*FederationRelationship_SpiffeId); ok {
		return x.SpiffeId
	}
	return ""
}

func (x *FederationRelationship) GetUseWebPki() bool {
	if x, ok := x.GetAuthentication().(*FederationRelationship_UseWebPki); ok {
		return x.UseWebPki
	}
	return false
}
...
type FederationRelationship_SpiffeId struct {
	// Use SPIFFE authentication. Specifies the expected SPIFFE ID
	// of the SPIFFE bundle endpoint server. The SPIRE Server SPIFFE ID
	// within the trust domain will be used if this is empty.
	SpiffeId string `protobuf:"bytes,4,opt,name=spiffe_id,json=spiffeId,proto3,oneof"`
}

type FederationRelationship_UseWebPki struct {
	// Use Web PKI authentication.
	UseWebPki bool `protobuf:"varint,5,opt,name=use_web_pki,json=useWebPki,proto3,oneof"`
}

func (*FederationRelationship_SpiffeId) isFederationRelationship_Authentication() {}

func (*FederationRelationship_UseWebPki) isFederationRelationship_Authentication() {}
...
var file_spire_api_types_federationrelationship_proto_rawDesc = []byte{
	...
	0xbc, 0x01, 0x0a, 0x16, 0x46, 0x65, 0x64, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	,
...
var file_spire_api_types_federationrelationship_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_spire_api_types_federationrelationship_proto_goTypes = []interface{}{
	...
	(*FederationRelationshipMask)(nil), // 1: spire.api.types.FederationRelationshipMask
}
...
func file_spire_api_types_federationrelationship_proto_init() {
	...
	file_spire_api_types_federationrelationship_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*FederationRelationship_SpiffeId)(nil),
		(*FederationRelationship_UseWebPki)(nil),
	}
	type x struct{}
